...
<html data-ng-app="page.viewer" data-enforce-browser="" class="ng-scope"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script id="twitter-wjs" src="./game_new_files/widgets.js"></script><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>
	...
	<link type="text/plain" rel="author" href="http://udacity.com/humans.txt">
		...
		<link rel="stylesheet" type="text/css" href="./game_new_files/udacity.min.css">

	


	<script type="text/javascript" id="www-widgetapi-script" src="./game_new_files/www-widgetapi.js" async=""></script><script type="text/javascript" async="" src="./game_new_files/munchkin.js"></script><script type="text/javascript" async="" src="./game_new_files/bHt.js"></script><script type="text/javascript" async="" src="./game_new_files/analytics.js"></script><script src="./game_new_files/iframe_api"></script><script type="text/javascript" async="" src="./game_new_files/dc.js"></script><script async="" src="./game_new_files/gtm.js"></script><script type="text/javascript">
		...
		<script src="./game_new_files/jquery-1.10.2.min.js"></script>
		<script type="text/javascript">
			if (typeof jQuery === 'undefined') {
				document.write(unescape("%3Cscript src='/media/js/standalone/libs/jquery-1.10.2.min.js'%3E%3C/script%3E"));
			}
		</script>
	<script type="text/javascript" src="./game_new_files/raygun.js"></script>
	<script>
	...
	<script src="./game_new_files/655050218.js"></script>
...
<script type="text/javascript" async="" src="./game_new_files/munchkin(1).js"></script><style type="text/css"></style><style type="text/css">/*.lleo_errorSelection *::-moz-selection,
				...
				<div class="navbar-header">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse">
						...
						<a itemprop="brand" itemscope="" itemtype="http://schema.org/Brand" class="logo navbar-brand" href="https://www.udacity.com/" id="header-logo">
							...
							<img alt="Udacity Logo" src="./game_new_files/LUgsz3XTdD-dW9qCenNcFZWaBKM6At_MbMjODMCJOC8ZoR4hIm_rVBQghBmk5kQ-kRa66yhEQT0BH88gUmwX=s85" srcset="//lh4.ggpht.com/LUgsz3XTdD-dW9qCenNcFZWaBKM6At_MbMjODMCJOC8ZoR4hIm_rVBQghBmk5kQ-kRa66yhEQT0BH88gUmwX=s170 2x" style="width:85px;">
						</a>
						...
						<ul data-user-menu="" class="nav navbar-nav navbar-right">
							<li class="dropdown ng-scope" data-ng-controller="myCoursesDropDown" data-ng-click="manualInitialize()">
								...
								<ul class="dropdown-menu dropdown-menu-scrollable dropdown-menu-scrollable-max my-courses-dropdown">
									<li class="dropdown-menu-loading ng-hide" data-ng-show="loading"><img src="./game_new_files/tp_loading.gif"></li>
...
<div class="ng-hide" data-group-chat="" data-ng-show="showGroupChat"><div class="chat">
	...
	<img data-ng-hide="notifications.hasUnreadMessages" src="./game_new_files/WidgetNormal.svg" width="65" height="65" class="">
	<img data-ng-show="notifications.hasUnreadMessages" src="./game_new_files/WidgetUnread.svg" width="65" height="65" class="ng-hide">
</div>
</div>
	...
	<div class="modal-header ng-scope">
		<div class="text-center">
			<img src="./game_new_files/GroupIntroTop.svg" width="200" height="90" alt="">
	...
	<div class="modal-body ng-scope">
		...
		<div class="row row-gap-medium">
			...
			<div class="col-xs-12">
				<div class="row">
					<div class="col-xs-12 text-center">
						<img src="./game_new_files/GroupIntroTopic.svg" height="100">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12 text-center">
...
<div class="row row-gap-medium">
	...
	<div class="modal-header ng-scope">
		<div class="row">
			<div class="col-xs-12 text-center">
				<img src="./game_new_files/GetStarted.svg" width="200" height="90" alt="">
			</div>
		</div>
	</div>
	<div class="modal-body ng-scope">
	...
	<div class="modal-body ng-scope">
		...
		<!-- ngIf: course['_semantic_type'] !== 'Degree' --><div class="row ng-scope" data-ng-if="course[&#39;_semantic_type&#39;] !== &#39;Degree&#39;">
			...
			<div class="hidden-xs col-sm-4 text-align-center">
				<img class="img-responsive" alt="Check mark on a lesson in a path of lessons" src="./game_new_files/y6SPDJFkkPSh3VjSWDnLjcepWoVybZcAVPTkomeX3BNbgVi-LZx36dq1Ci_BDz2SlWx-fkwtPZS5faxWTQQ=s198">
			</div>
	...
	<div class="modal-body ng-scope">
		...
		<!-- ngIf: course['_semantic_type'] !== 'Degree' --><div class="row ng-scope" data-ng-if="course[&#39;_semantic_type&#39;] !== &#39;Degree&#39;">
			<div class="col-xs-4 col-xs-push-4 col-sm-push-8 text-align-center">
				<img class="img-responsive" alt="Space ship blasting off" src="./game_new_files/G-VNxbbq2TvqAaupYg215_cpDhytI6FNJZtG33zFnQM9i78XsbuT2TVpUe-KdrRaHii0H9KDNKF6Za3RARs=s198">
			</div>
	...
	<div class="modal-body ng-scope">
		<div class="row">
			...
			<div class="hidden-xs col-sm-4">
				<img class="img-responsive" src="./game_new_files/WKHAg0cKAl6-dzViz2RWuKFObfO1izzXE-yhMSoPNRxB2pNIf5-RgM-ewPfGZ95_5Xd0hcjwDcg_XUX85Q=s159" alt="a symbol of learning">
			</div>
		</div>
	</div>
	<div class="modal-footer ng-scope">
		...
		<a class="btn btn-primary" data-ng-href="/checkout#!/0?products=4650547530956800" href="https://www.udacity.com/checkout#!/0?products=4650547530956800">
			...
			<div class="viewer-loading-overlay text-center ng-hide" data-ng-show="!lesson || isViewerLoading">
				<div style="margin-top: 200px;">
					<img src="./game_new_files/b3OandPWsUWAnRVS5d8JS8OL0nu8dU2d3NceS7p1yKhPl9KD4EhqeylPm7yFbft5wmsA2VCAZ-8wAkmFduXJ=s0">
...
<div class="col-xs-9 ng-scope">
	<div data-player-loading-mask="" class="player-loading-mask"><div class="player-loading-overlay ng-hide" data-ng-show="isPlayerLoading" data-fade-out="200"><div class="player-loading-overlay-message"><img alt="Loading..." src="./game_new_files/b3OandPWsUWAnRVS5d8JS8OL0nu8dU2d3NceS7p1yKhPl9KD4EhqeylPm7yFbft5wmsA2VCAZ-8wAkmFduXJ=s0"></div></div><div data-ng-transclude="">
	...
	<img class="image-background" alt="" style="display:block;" data-ng-src="//lh3.ggpht.com/Xev1rWueMpBLrXLFpAZpQP92qP2K9ziZK12tidhcwwe_9B8JyZpv-qSsXepTpX_QXNdXzrCgekVxdMZJVsA=s889#w=1920&amp;h=1080" src="./game_new_files/Xev1rWueMpBLrXLFpAZpQP92qP2K9ziZK12tidhcwwe_9B8JyZpv-qSsXepTpX_QXNdXzrCgekVxdMZJVsA=s889">
</div>
...
<p>Make sure to take note of where you download them!</p></div></div>
	...
	<div class="col-xs-2 text-right">
		<img data-ng-show="isAccessAllowed()" src="./game_new_files/hJcAFWEZUQKz9x8A-YT6-mH-vKd4PH4uOwqbmCoahSUAYdyXAN2IvutaPD80jrRa9AGuG4AFJ0QAajpeUEs=s15" alt="download this material" class="">
		<img data-ng-hide="isAccessAllowed()" src="./game_new_files/gOt1oNZq53r48qoFKHib0ZzlB4UM5iEnAU2AhcVkOjuWx5fdjXr9-cbJ8gTs6pQ0_JRREsVaMFT88rR-uA=s15" alt="subscribe to access this extra material" class="ng-hide">
	</div>
	...
	<div class="placard-medium ng-scope" data-guided-tour-placard="downloadables-introduction" style="z-index: 10001; position: relative;"><div class="guided-tour-placard-container" data-ng-class="{&#39;guided-tour-placard-container-current&#39;: show}"><div class="guided-tour-placard">
		<div class="text-center ng-scope">
			<img src="./game_new_files/Gw5YfKdYN_FfThHdCrdYLv8Wwr_xSWy7jD97DUokT_6wmT-N3fE9gcbSEqKdj1JEKfuFmDMkVnA3NOsVKCU=s0">
		</div>
		<div class="ng-scope">
			<strong>
	...
	<div class="modal-body ng-scope">
		<div class="row">
			...
			<div class="hidden-xs col-sm-2">
				<img class="img-responsive" data-ng-src="//lh6.ggpht.com/pKx-eRzHw9M9hv8Fiejxj5GkUYQRfbzXe9sHndvm8gps3wEU46A-s4JzRn1rJOWlspwb1_YGpvqmQUNvnNwz=s140#w=494&amp;h=1061" alt="Sad robot" src="./game_new_files/pKx-eRzHw9M9hv8Fiejxj5GkUYQRfbzXe9sHndvm8gps3wEU46A-s4JzRn1rJOWlspwb1_YGpvqmQUNvnNwz=s140">
			</div>
		</div>
	</div>
						...
						<div class="row row-gap-medium">
							<div class="col-xs-12">
								<div class="row-gap-medium">
									<div class="col-xs-12">
										<div class="text-center">
												<img src="./game_new_files/profane_graphic.svg" width="110" height="60" alt="Magnifying glass finding swearing in text">
										</div>
									</div>
								</div>
		...
		<div class="col-xs-12">
			<div class="text-center-xs">
				<a href="https://itunes.apple.com/us/app/id819700933?mt=8">
					<img alt="Apple store" class="img-initial mobile-button" src="./game_new_files/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX04gbr_KrDSx8SDDBpGRHAWU=s150" srcset="//lh6.ggpht.com/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX04gbr_KrDSx8SDDBpGRHAWU=s300#w=300&amp;h=88 2x">
				</a>
				<a href="https://play.google.com/store/apps/details?id=com.udacity.android">
					<img alt="Google Play" class="mobile-button" src="./game_new_files/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKGbMPgolJ2wIlY23yI9OODDss=s150" srcset="//lh5.ggpht.com/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKGbMPgolJ2wIlY23yI9OODDss=s300#w=300&amp;h=88 2x">
				</a>
			</div>
		</div>
	</div>
...
<div class="row row-gap-small">
	...
	<script type="text/javascript">
		...
		<script src="./game_new_files/angular.min.js"></script>
		<script type="text/javascript">
		...
		<script type="text/javascript" src="./game_new_files/libs.min.js"></script>
<script type="text/javascript" src="./game_new_files/udacity.min.js"></script>
	...
	<script type="text/javascript">
		...
		<script type="text/javascript" src="./game_new_files/chat_libs.min.js"></script>
		<script type="text/javascript" src="./game_new_files/chat.min.js"></script>
	...
	<div class="what-is-wrong-with-google-remarketing">
		...
		<script type="text/javascript" src="./game_new_files/conversion.js"></script>
		<noscript>
